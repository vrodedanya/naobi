...
naobi::operation::operation(std::string operatorName, int priority, naobi::command::names commandAnalogue,
...
{
	auto it = std::find_if(_operations.begin(), _operations.end(), [operation](const operation::sptr& s)
...
std::vector<naobi::operation::sptr> naobi::operation_manager::_operations = {
		...
		std::make_shared<naobi::operation>(">=", 3, naobi::command::names::GREATER_OR_EQ,
		...
		std::make_shared<naobi::operation>("<=", 3, naobi::command::names::LESS_OR_EQ,
										   naobi::operation::implementations({
																					 {std::make_pair(
																							 utils::type::names::INTEGER,
																							 utils::type::names::INTEGER),
