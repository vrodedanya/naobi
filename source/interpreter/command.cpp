...
std::map<naobi::command::names, naobi::command::implementation> naobi::command::commands =
		{
				{naobi::command::names::ADD,
												...
												[[maybe_unused]]const naobi::command::argumentsList& args)
											 {
												 ...
												 context->stack.push(
														 naobi::operation_manager::get("+")->call(first->type(),
																								  second->type()).second(
																 first, second));
											 }},
				...
				{naobi::command::names::INPUT,
												...
												[[maybe_unused]]const naobi::command::argumentsList& args)
											 {
												 std::string str;
												 std::cin >> str;
												 auto var = std::make_shared<naobi::variable>("temp",
				...
				{naobi::command::names::I2S, [](const naobi::workflow_context::sptr& context,
				...
				{naobi::command::names::F2S, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
				...
				{naobi::command::names::B2S, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
												 top->type() = utils::type::names::STRING;
				...
				{naobi::command::names::S2I, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
				...
				{naobi::command::names::F2I, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
												 top->type() = utils::type::names::INTEGER;
				...
				{naobi::command::names::B2I, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
												 top->type() = utils::type::names::INTEGER;
				...
				{naobi::command::names::I2F, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
				...
				{naobi::command::names::S2F, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
												 top->type() = utils::type::names::FLOAT;
				...
				{naobi::command::names::I2B, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
				...
				{naobi::command::names::S2B, [](const naobi::workflow_context::sptr& context,
												const naobi::command::argumentsList& args) noexcept
											 {
												 auto top = context->stack.top();
												 top->type() = utils::type::names::BOOLEAN;
